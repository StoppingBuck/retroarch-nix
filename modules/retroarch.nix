...
let
  ...
  # Cores recommended by Emulation General Wiki based on accuracy and activity
  availableCores = {
    # 🟥 Atari
    stella = {
      package = pkgs.libretro.stella;
      producer = "Atari";
      systems = [ "2600" ];
    };
    atari800 = {
    ...
    prosystem = {
      package = pkgs.libretro.prosystem;
      producer = "Atari";
      systems = [ "7800" ];
    };
    virtualjaguar = {
      package = pkgs.libretro.virtualjaguar;
      producer = "Atari";
      systems = [ "Jaguar" ];
    };
    beetle-lynx = {
    ...
    # 🟦 Nintendo
    mesen = {
      package = pkgs.libretro.mesen;
      producer = "Nintendo / Bandai";
      systems = [ "NES", "Famicom", "Bandai WonderSwan" ];
    };
    sameboy = {
    ...
    beetle-vb = {
      package = pkgs.libretro.beetle-vb;
      producer = "Nintendo";
      systems = [ "Virtual Boy" ];
    };
    mupen64plus = {
    ...
    # 🟨 Sony
    beetle-psx = {
      package = pkgs.libretro.beetle-psx;
      producer = "Sony";
      systems = [ "PlayStation" ];
    };
    pcsx2 = {
    ...
    puae = {
      package = pkgs.libretro.puae;
      producer = "Commodore";
      systems = [ "Amiga" ];
    };
    vecx = {
      package = pkgs.libretro.vecx;
      producer = "GCE";
      systems = [ "Vectrex" ];
    };
    freeintv = {
      package = pkgs.libretro.freeintv;
      producer = "Mattel";
      systems = [ "Intellivision" ];
    };
    bluemsx = {
      package = pkgs.libretro.bluemsx;
      producer = "Microsoft";
      systems = [ "MSX" ];
    };
    beetle-supergrafx = {
      package = pkgs.libretro.beetle-supergrafx;
      producer = "NEC";
      systems = [ "TurboGrafx 16", "PC Engine" ];
    };
    o2em = {
      package = pkgs.libretro.o2em;
      producer = "Philips / Magnavox";
      systems = [ "Videopac+", "Odyssey²" ];
    };
    fuse = {
      package = pkgs.libretro.fuse;
      producer = "Sinclair";
      systems = [ "ZX Spectrum" ];
    };
    beetle-ngp = {
      package = pkgs.libretro.beetle-ngp;
      producer = "SNK";
